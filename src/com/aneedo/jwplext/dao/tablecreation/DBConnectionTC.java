...
import java.sql.Statement;
 ...
 public class DBConnectionTC
 {
	 private static DBConnectionTC dbConn = null;
	 private static final String url = "jdbc:mysql://localhost:3306/";
	 private static final String db = "wikipedia";
	 private static final String driver = "com.mysql.jdbc.Driver";
	 private static final String user = "root";
	 private static final String pass = "aneedo";

	 private DBConnectionTC() throws ClassNotFoundException  {
	        Class.forName(driver);

	 }
	
	 public static DBConnectionTC getInstance() throws ClassNotFoundException {
		 	if(dbConn == null) {
				dbConn = new DBConnectionTC();
			}
